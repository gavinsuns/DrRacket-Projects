...
;; valid-date?: Nat -> Bool
(define (valid-date? x) (and (false? (and (> x 17520902) (< x 17520914)))
                              (and (valid-month? (month x)) (valid-day? x))))
...
;; leap-year?: Nat -> Bool
(define (leap-year? x) (false? (or (and (false? (integer? (/ x 400))) (integer? (/ x 100)))
                             (false? (integer? (/ x 4))))))
...
;; valid-day?: Nat -> Bool
(define (valid-day? x) (or (and (or (= (month x) 1) (= (month x) 3) (= (month x) 5) (= (month x) 7)
                            (= (month x) 8) (= (month x) 10) (= (month x) 12)) (<= (day x) 31) (> (day x) 0))
                       (and (or (= (month x) 4) (= (month x) 6) (= (month x) 9) (= (month x) 11))
                            (<= (day x) 30) (> (day x) 0))
                       (and (leap-year? (year x)) (= (month x) 2) (<= (day x) 29) (> (day x) 0))
